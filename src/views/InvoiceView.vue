...
const toggleEditInvoice =()=>{
    ...
    invoiceStore.infoShow = true

}
const toggleConfimationModal = (id)=>{         
    invoiceStore.toggleDeleteInvoice() 
   
}

const updateStatusToPaid = (id) =>{
    invoiceStore.updateStatusPaid(id)
}
const updateStatusToPending = (id) =>{
    invoiceStore.updateStatusPending(id)
}
    ...
    <div  v-if="currentInvoice" class="invoice-view container">
        ...
        <div class="header flex">
            ...
            <div class="right flex">
                ...
                <button @click="toggleConfimationModal()" class="red">Delete</button>
